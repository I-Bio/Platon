# Generated by Django 4.2.6 on 2023-12-15 17:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='', max_length=256)),
                ('description', models.TextField(default='')),
                ('start_date', models.DateTimeField(default=datetime.datetime(2023, 12, 15, 17, 1, 30, 456688, tzinfo=datetime.timezone.utc))),
                ('end_date', models.DateTimeField(default=datetime.datetime(2023, 12, 15, 17, 1, 30, 472645, tzinfo=datetime.timezone.utc))),
            ],
        ),
        migrations.CreateModel(
            name='Test',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_delivery', models.DateTimeField(default=datetime.datetime(2023, 12, 15, 17, 1, 30, 478628, tzinfo=datetime.timezone.utc))),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
