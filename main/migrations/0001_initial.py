# Generated by Django 4.2.6 on 2023-12-15 17:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='', max_length=256)),
                ('enrolled_groups_id', models.JSONField(blank=True, default=list, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='', max_length=256)),
                ('description', models.TextField(default='')),
                ('start_date', models.DateTimeField(default=datetime.datetime(2023, 12, 15, 17, 12, 34, 683455, tzinfo=datetime.timezone.utc))),
                ('end_date', models.DateTimeField(default=datetime.datetime(2023, 12, 15, 17, 12, 34, 708389, tzinfo=datetime.timezone.utc))),
            ],
        ),
        migrations.CreateModel(
            name='Test',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('own_grade', models.IntegerField(blank=True, default=0, null=True)),
                ('checker_grade', models.IntegerField(blank=True, default=0, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_delivery', models.DateTimeField(default=datetime.datetime(2023, 12, 15, 17, 12, 34, 713376, tzinfo=datetime.timezone.utc))),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
