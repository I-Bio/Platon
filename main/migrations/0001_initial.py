    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='Без названия', max_length=128)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('question_name', models.CharField(default='Без названия', max_length=128)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lectures', models.ManyToManyField(to='main.lecture')),
                ('references', models.ManyToManyField(to='main.reference')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('study_Group', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='main.studentgroup')),
