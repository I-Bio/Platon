# Generated by Django 4.2.6 on 2024-03-02 06:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(default='', max_length=256)),
                ('description', models.TextField(default='')),
                ('start_date', models.DateTimeField(default=datetime.datetime(2024, 3, 2, 6, 6, 44, 736153, tzinfo=datetime.timezone.utc))),
                ('end_date', models.DateTimeField(default=datetime.datetime(2024, 3, 2, 6, 6, 44, 749142, tzinfo=datetime.timezone.utc))),
            ],
        ),
        migrations.CreateModel(
            name='Test',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_delivery', models.DateTimeField(default=datetime.datetime(2024, 3, 2, 6, 6, 44, 756122, tzinfo=datetime.timezone.utc))),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
